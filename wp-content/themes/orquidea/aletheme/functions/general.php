...
if ( function_exists('register_sidebar') ) {
        ...
        register_sidebar(array(
            'name' => 'Left Sidebar',
            'id' => 'left-sidebar',
            'description' => 'Appears as the left sidebar',
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<div class="widtitle"><h4 class="widgettitle">',
            'after_title' => '</h4></div> ',
        ));
...
function pbd_alp_init() {
    ...
    if(is_page_template('template-blog.php') or is_page_template('template-blog-twocol.php') or is_page_template('template-blog-fourcol.php')) {

        wp_enqueue_script(
            'pbd-alp-load-posts',
            get_template_directory_uri() . '/js/libs/load-posts.js',
            array('jquery'),
            '1.0',
            true
        );
